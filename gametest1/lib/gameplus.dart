...
class gameplus extends StatefulWidget {
  ...
  @override
  gameplusd createState() => gameplusd();
}

class gameplusd extends State<gameplus> {
  ...
  Widget build(BuildContext context) {
    ...
    var num1 = Random().nextInt(30);
    var num2 = Random().nextInt(30);
    var num3 = Random().nextInt(30);
    var num4 = Random().nextInt(30);
    //-----------------------------/สุ่มเลขและเก็บไว้ในตัวแปล num(1-4)-----------------------------//
                  ...
                  child: Column(children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, 154, 255, 123),
                      ),
                      child: Text(
                        'ด่านที่ ' + '$_loopplus',
                        style: TextStyle(
                        ...
                        Container(
                          ...
                          child: TextButton(
                            style: TextButton.styleFrom(
                              backgroundColor:
                                  Color.fromARGB(255, 154, 255, 123),
