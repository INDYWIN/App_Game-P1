...
class gamedivision extends StatefulWidget {
  static Future<void> navigatorPush(BuildContext context) async {
    return Navigator.push<void>(
      context,
      MaterialPageRoute(
        builder: (_) => gamedivision(),
      ),
    );
  }

  var nameg;
  gamedivision({this.nameg});

  @override
  gamedivisiond createState() => gamedivisiond();
}

class gamedivisiond extends State<gamedivision> {
  ...
  Widget build(BuildContext context) {
    ...
    var num1 = Random().nextInt(10) + 5;
    var num2 = Random().nextInt(10) + 5;
    var num3 = Random().nextInt(5) + 1;
    var num4 = Random().nextInt(5) + 1;
    //-----------------------------/สุ่มเลขและเก็บไว้ในตัวแปล num(1-4)-----------------------------//
    //-----------------------------เก็บการหาร-----------------------------//
    var num5 = num1 / num3;
    var num6 = num2 / num4;
                        ...
                        Container(
                          ...
                          child: TextButton(
                            style: TextButton.styleFrom(
                              backgroundColor:
                                  Color.fromARGB(255, 144, 255, 255),
