...
class gamemultiply extends StatefulWidget {
  static Future<void> navigatorPush(BuildContext context) async {
    return Navigator.push<void>(
      context,
      MaterialPageRoute(
        builder: (_) => gamemultiply(),
      ),
    );
  }

  var nameg;
  gamemultiply({this.nameg});

  @override
  gamemultiplyd createState() => gamemultiplyd();
}

class gamemultiplyd extends State<gamemultiply> {
  ...
  Widget build(BuildContext context) {
    ...
    var num1 = Random().nextInt(12);
    var num2 = Random().nextInt(12);
    var num3 = Random().nextInt(12);
    var num4 = Random().nextInt(12);
    //-----------------------------/สุ่มเลขและเก็บไว้ในตัวแปล num(1-4)-----------------------------//
                  ...
                  child: Column(children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, 144, 144, 255),
                      ),
                      child: Text(
                        'ด่านที่ ' + '$_loopplus',
                        style: TextStyle(
                    ...
                    /*-----------------------------------------------อธิบาย-----------------------------------------------*/
                    /*การทำงานจะแสดง ตัวเลือกที่1 = num1 x num3 กับ ตัวเลือกที่2 = num2 x num4 */
                    /*กรณีที่ ตัวเลือกที่1 จะถูกก็ต่อเมื่อ num1 มากกว่า num2 ถ้าไม่ ตัวเลือกที่2 ก็จะถูก*/
                    /*อธิบาย : เพราะการจะแสดงโจทย์ จะเอาค่าที่มากกว่ามาแสดงเช่น num1 มากกว่าก็จะแสดง num1 x num3 ทำให้ค่าตรงกับ ตัวเลือกที่1*/
                    /*อธิบาย : ถ้า num2 มากกว่าจะแสดง num2 x num4 ทำให้ค่าตรงกับ ตัวเลือกที่2*/
                        ...
                        Container(
                          ...
                          child: TextButton(
                            style: TextButton.styleFrom(
                              backgroundColor:
                                  Color.fromARGB(255, 144, 144, 255),
